...
Additionally, I contributed to the development of the user personas and worked on finding and reading in datasets for crop health that we plan to use for our project. Analyzing the validity of data included evaluating factors like accessibility, biases, and whether the dataset contained features that were both relevant and large enough to support the goals of our project.
