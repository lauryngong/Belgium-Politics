...
On the UI end, I worked with my teammates to adjust the theme of our app to be more agriculture centered and added descriptions/help buttons for each input feature for the crop predictor model.